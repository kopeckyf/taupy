...
between their belief systems. Agents can inhibit the centre of a graph or be far 
...
In the graph below, the top position has a distance of 1 to each of the 
others, and the others have a higher distance toward each other. The top agent
